...
:root{
  ...
  --faint-strong: #8A8A92;  /* ~5.7:1 信息性小字（特性示例/元信息/脚注）v1.2 新增 */
...
| 日期 | 版本 | 说明 |
|---|---|---|
| 2026-08-07 | v1.2 | 对比度修补：新增 `--faint-strong`（#8A8A92，~5.7:1）用于信息性小字（特性示例/元信息/脚注，§4.2/§4.4/§4.10 同步更新）；`--faint` 收窄为纯装饰用途，禁止承载任何文字 |
