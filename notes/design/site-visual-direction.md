...
> v1.4 豁免：/share/ 样例页按 share-page-template v4.0 复用（见 §4.7/v1.3），其 topbar `backdrop-filter: blur(8px)` 为 Claude Code app 风格的一部分，属本站唯一允许的毛玻璃元素；其余页面仍禁。
...
| 日期 | 版本 | 说明 |
|---|---|---|
| 2026-08-07 | v1.4 | §1 豁免：/share/ 样例页 topbar backdrop-blur（Claude Code app 风格，模板 v4.0 自带）为全站唯一允许的毛玻璃元素，其余页面仍禁 |
