...
pub struct ProviderConfig {
    ...
    /// Environment variable holding the API key (`envKey`, D64): keeps the key
    ...
    /// Declared model list (`models`, D64). Declared means authoritative: the
...
/// the prefix table would otherwise have to guess (D64).
#[derive(Debug, Clone, PartialEq, Deserialize)]
#[serde(untagged)]
pub enum ModelEntry {
    Id(String),
...
mod tests {
    ...
    /// D64 settings v3: `models` accepts bare ids and objects in one list,
