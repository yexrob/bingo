...
`/open <@agent|#channel|#team|hub>` (enter a conversation; Tab completes from the ones that exist, and it runs mid-turn; Ctrl+K is the same door without typing a name) ·
